...
+ Airline Specific
    + In the above comparison I chose to focus on the percantage by airline as opposed to the raw numbers(although I do some raw number displays)
        ...
        + Such analysis can't account for confoudning vairables.  Perhaps Alaska only flys on certain days/times of the week, where there are less overall delays  
